...
| Intelligence band | track, both shaders | "It is the fabric": as the band comes up, warmth spreads from the ember line through the whole sheet along a ragged front and holds until the band leaves. Capped below full ember so the fabric warms rather than blazes, and only the line blooms. The one place on the page the ember leaves its line. |
