    ...
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled
          ...
          : "bg-white border-b border-transparent shadow-md"
      }`}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 w-full">
          
          {/* Brand Logo & Desktop Nav Group */}
          ...
          {/* Right Group (CTA, Socials on desktop, Hamburger on mobile) */}
          <div className="flex items-center space-x-4">
            ...
            <Link
              href="/contact"
              onClick={closeAllDropdowns}
              className="inline-flex items-center justify-center px-5 h-10 border border-transparent text-sm font-medium text-white bg-red-600 hover:bg-red-700 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-colors"
            >
              Contact us
            </Link>
