  ...
  return (
    <>
      ...
      <div className="relative w-full h-[300px] md:h-[500px]">
        ...
        <img src={study.image} alt={study.title} className="w-full h-full object-cover" loading="eager" />
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="relative w-full overflow-hidden rounded-lg shadow-lg mt-10">
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src={study.image} alt={study.title} className="w-full lg:h-[500px] object-cover" />
        </div>
      </section>
