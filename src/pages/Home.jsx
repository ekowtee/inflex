        ...
        <>
            ...
            <div className="w-full">
                ...
                <div className="relative w-full">
                    ...
                    {/* Hero content with consistent margins */}
                    <div className="absolute inset-0">
                        <div className="container mx-auto px-4 md:px-8 lg:px-16 xl:px-24 2xl:px-32 h-full">
                            <div className="absolute bottom-10 md:bottom-28 lg:bottom-24 4xl:bottom-[50px] w-full md:w-[571px] 4xl:w-[800px] flex flex-col justify-center items-start">
                                <h1
                                    ref={titleRef}
                                    className={`
                                        ${base}
                ...
                {/* Partners Section with consistent margins */}
                <div className="container mx-auto px-4 md:px-8 lg:px-16 xl:px-24 2xl:px-32">
                    <Partners />
                </div>

                {/* Strategic Partner Section */}
                <section className="container mx-auto px-4 md:px-8 lg:px-16 xl:px-24 2xl:px-32">
                    <div className='flex flex-col md:flex-col lg:flex-row w-full lg:h-[554px]'>
                        ...
                        <div className='relative flex flex-1 items-center justify-center mt-2 md:mt-0 lg:mt-0'>
                            <div className='relative'>
                                ...
                                <div className='absolute top-20 md:top-32 lg:top-32 4xl:top-32 left-1/2 transform -translate-x-1/2'>
                                    <img src={imagesvg} alt='svgbg' className='w-[490px] h-[353px] object-contain' loading='lazy' />
                                </div>

                                {/* Floating badges positioned relative to the image */}
                                <div
                                    ref={item1Ref}
                                    className={`
                                        ${base}
                                        ${item1In ? "translate-x-0 opacity-100 delay-[1600ms]" : "translate-x-[50px] opacity-0"}
                                        absolute top-[165px] left-[-50px]
                ...
                <div className="container mx-auto px-4 md:px-8 lg:px-16 xl:px-24 2xl:px-32">
                    <div className="flex flex-col md:flex-col lg:flex-row lg:h-[800px] h-full w-full gap-x-10">
                        <div data-aos="flip-right" className="flex-1 py-2 md:py-4 lg:py-0">
                            <img
                                src={subtract}
                                alt="sub"
                        ...
                        <div className="flex-1 py-4 md:py-10 lg:py-20">
                            <div className='flex flex-col gap-8 w-full lg:w-[700px] 4xl:w-[600px] lg:h-[700px]'>
                                <h2 className="lg:w-[500px] lg:h-[93px] lg:text-[32px] md:text-[32px] text-[20px] lg:leading-[40px] font-normal text-[#265982]">
                                    Comprehensive Solutions for Modern Challenges
                                </h2>
                                <div className="lg:w-[555px] 4xl:w-full lg:space-y-4 space-y-4">
                                    <SwapGrid />
                                </div>
                            </div>
                        </div>
                ...
                <section className="container mx-auto px-4 md:px-8 lg:px-16 xl:px-24 2xl:px-32 py-12">
                    <h2 className="md:text-3xl 4xl:text-5xl font-normal text-gray-900 mb-12">
                        The Inflexions Advantage
                    </h2>
                ...
                {/* Call to Action Banner - Full width background with contained content */}
