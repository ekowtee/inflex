    ...
    return (
        <>
                    ...
                    <div className="container mx-auto px-4 lg:pl-[240px] 4xl:pl-[240px] lg:pr-[160px]">
                        <div className="flex flex-col md:flex-row justify-between items-start gap-8">
                            <div className="md:w-1/2 text-white space-y-4 pt-[200px]">
                                <h1 data-aos="fade-right" className="text-3xl lg:text-4xl font-bold">
                                ...
                                <p data-aos="fade-right" data-aos-delay="200" className="text-lg lg:text-xl font-light opacity-90">
                                    Discover how we bridge complex technology and business goals
                                </p>
                            </div>
                            ...
                            <div data-aos="fade-left" className="w-[326px] h-[360px] hidden md:block lg:block bg-[#BD2E25] p-8 text-white space-y-6 mt-8">
                                ...
                                <ul className="space-y-4 text-sm">
                                    ...
                                    <li>
                                        ...
                                        <p>
                                            To be a thought-leading provider of IT solutions that give our customers a competitive edge through technology expertise and partnership.
                                        </p>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div className="flex flex-col md:flex-row gap-8 items-center">
                        <div className="w-full lg:w-1/2 space-y-10">
                            <div className="w-full lg:w-3/4 space-y-6">
                                <h2 className="text-[24px] md:text-[33.35px] font-normal text-[#16213E] leading-[32px] md:leading-[40px]">
            ...
            <section className="py-16 bg-[#F6F6F6]">
                <div className="container mx-auto px-4 lg:pl-[240px] 4xl:pl-[240px] lg:pr-[227px] 4xl:pr-[255px]">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-[193px] 4xl:gap-[390px] items-center">
                        <div className="w-full lg:w-[498px] space-y-6">
                            <div>
                                <h2 data-aos="zoom-in-down" className="text-[26px] md:text-[33px] font-normal text-[#1E3161] leading-[32px] md:leading-[42px] mb-4">
                                    Excellence in Every Partnership - Your Technology Partner, From Foundation to Future
                                </h2>
                                <p data-aos="zoom-in-down" className="text-base text-gray-600">
                                    Our experienced team combines technical mastery with business insight, ensuring every solution drives measurable results for your organization.
                                </p>
                            </div>
            ...
            <section>
                <div className="relative">
                    <iframe
                        title="Location map of Dei Close, East Legon, Accra"
                    ...
                    <div className="md:hidden flex absolute bg-white border-t-4 border-[#2A2A2A] z-10 w-[90%] sm:w-[480px] h-auto sm:h-[285px] left-1/2 sm:left-[240px] top-[400px] sm:top-[350px] -translate-x-1/2 sm:translate-x-0 lg:flex items-center justify-center">
